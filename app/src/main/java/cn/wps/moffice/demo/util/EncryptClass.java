...
public class EncryptClass
{
	...
	public static int openFile(String path, OfficeOutputStream output) throws RemoteException
	{
	 ...
	 * @throws RemoteException
	 */
	public static int saveFile(OfficeInputStream input, String path) throws RemoteException
	{
		if (input == null)
			return -1;
