...
public class ATEditParamActivity extends Activity{
	...
	//设置参数常量信息
		private final String[] SETTING = 
		{
				...
				Define.AT_PASTE,
				Define.AT_EDIT_TEXT,
				Define.AT_EDIT_PICTURE,
				Define.AT_EDIT_SHAPE,
				Define.AT_EDIT_CHART,
				Define.AT_SHARE,
				Define.AT_PRINT,
	...
	*/
	private ArrayList<HashMap<String, Object>> getDate() {
		...
		map6.put("id", j++);
		map6.put("ItemTitle", "编辑文字");
		map6.put("ItemText", "是否允许编辑文字");
		listItem.add(map6);
		
		HashMap<String, Object> map7 = new HashMap<String, Object>();
		map7.put("id", j++);
		map7.put("ItemTitle", "编辑图片");
		map7.put("ItemText", "是否允许编辑嵌入式的图片");
		listItem.add(map7);
		
		HashMap<String, Object> map8 = new HashMap<String, Object>();
		map8.put("id", j++);
		map8.put("ItemTitle", "编辑图片");
		map8.put("ItemText", "是否允许编辑浮动式的图片");
		listItem.add(map8);
		
		HashMap<String, Object> map9 = new HashMap<String, Object>();
		map9.put("id", j++);
		map9.put("ItemTitle", "编辑表格");
		map9.put("ItemText", "是否允许编辑表格");
		listItem.add(map9);
	...
	private class MyAdapter extends BaseAdapter 
	{
		...
		private void setIsSelected() 
		{
			...
			IsSelected[5] = preference.getSettingParam(Define.AT_EDIT_TEXT, true);
			IsSelected[6] = preference.getSettingParam(Define.AT_EDIT_PICTURE, true);
			IsSelected[7] = preference.getSettingParam(Define.AT_EDIT_SHAPE, true);
			IsSelected[8] = preference.getSettingParam(Define.AT_EDIT_CHART, true);
			IsSelected[9] = preference.getSettingParam(Define.AT_SHARE, true);
			IsSelected[10] = preference.getSettingParam(Define.AT_PRINT, true);
			IsSelected[11] = preference.getSettingParam(Define.AT_SPELLCHECK, true);
			IsSelected[12] = preference.getSettingParam(Define.AT_MULTIDOCCHANGE, true);
			IsSelected[13] = preference.getSettingParam(Define.AT_QUICK_CLOSE_REVISEMODE, true);
			IsSelected[14] = preference.getSettingParam(Define.AT_EDIT_REVISION, true);
		}
	}
